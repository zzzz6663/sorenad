    ...
    public function setting_ads_text(Request $request){
        if($request->isMethod("post")){
            $data=$request->validate([
                ...
                'txt_advertiser_show'=>"required",
                'txt_limit_order'=>"required",
                'txt_active_site'=>"required",
                'txt_user_vip_click'=>"required",
                'txt_user_vip_show'=>"required",
                'txt_user_normal_click'=>"required",
                'txt_user_normal_show'=>"required",
            ]);
            foreach($data as $key=>$val){
                $setting=Setting::whereName( $key)->first();
                $setting->update(['val'=>$val]);
        ...
        $txt_advertiser_click=Setting::whereName("txt_advertiser_click")->first();
        $txt_advertiser_show=Setting::whereName("txt_advertiser_show")->first();
        $txt_limit_order=Setting::whereName("txt_limit_order")->first();
        $txt_active_site=Setting::whereName("txt_active_site")->first();
        $txt_user_vip_click=Setting::whereName("txt_user_vip_click")->first();
        ...
        return view('admin.setting.setting_ads_text', compact([
            ...
            "txt_user_vip_click",
            "txt_user_vip_show",
            "txt_user_normal_click",
            "txt_user_normal_show",
        ]));
    }
