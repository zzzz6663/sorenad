                                ...
                                <div class="bs-stepper-content">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <select class="select2" id="gender" name="gender">
                                                    ...
                                                    <option {{ old("gender",$visit->gender)=="boy" ?"selected":"" }} value="boy">
                                                        پسرانه</option>
                                                    <option {{ old("gender",$visit->gender)=="both" ?"selected":"" }} value="both">
                                                        مختلط</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-4">
                                    ...
                                    <div class="content" id="other_info">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("sport_coach_count",$visit->sport_coach_count) }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("sport_coach_hour",$visit->sport_coach_hour) }}"
                                            ...
                                            <div class="col-sm-9">
                                                <label class="form-label" for="visitors">{{ __("field.visitors")
                                                    ...
                                                    <textarea name="visitors" id="visitors" class="form-control" cols="30" rows="4">{{ old("visitors",$visit->visitors) }}</textarea>
                                            </div>
                                    ...
                                    <div class="content" id="creative">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                           ...
                                           <textarea name="creative" class="form-control" id="" cols="30" rows="5">{{ old("creative",$visit->creative) }}</textarea>
                                        </div>
