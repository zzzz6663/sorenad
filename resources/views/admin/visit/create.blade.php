...
<div class="row">
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">تعریف بازدید جدید
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-label" for="unit_Name_educational">{{
                                                    __("basic1.unit_Name_educational") }}</label>
                                                <input type="text" value="{{ old("unit_Name_educational") }}"
                                                    class="form-control" id="unit_Name_educational"
                                                    name="unit_Name_educational" />
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label" for="location">{{ __("basic1.location")
                                                    }}</label>
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-label" for="gender">{{ __("basic1.gender")
                                                    }}</label>
                                                <select class="select2" id="gender" name="gender">
                                                    <option value="">انتخاب کنید </option>
                                                    <option {{ old("gender")=="girl" ?"selected":"" }} value="girl">
                                                        دخترانه</option>
                                                    <option {{ old("gender")=="boy" ?"selected":"" }} value="boy">
                                                        پسرانه</option>
                                                    <option {{ old("gender")=="both" ?"selected":"" }} value="both">
                                                        مختلط</option>
                                                </select>
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label" for="preiod">{{ __("basic1.preiod")
                                                    }}</label>
                                                <input type="text" value="{{ old("preiod") }}" class="form-control"
                                                    id="preiod" name="preiod" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="unit_type">{{ __("basic1.unit_type")
                                                    }}</label>
                                                <input type="text" value="{{ old("unit_type") }}" class="form-control"
                                                    id="unit_type" name="unit_type" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="manager_name">{{
                                                    __("basic1.manager_name") }}</label>
                                                <input type="text" value="{{ old("manager_name") }}"
                                                    class="form-control" id="manager_name" name="manager_name" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="manager_course">{{
                                                    __("basic1.manager_course") }}</label>
                                                <input type="text" value="{{ old("manager_course") }}"
                                                    class="form-control" id="manager_course" name="manager_course" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="manager_year_service">{{
                                                    __("basic1.manager_year_service") }}</label>
                                                <input type="text" value="{{ old("manager_year_service") }}"
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-label" for="manager_tell">{{
                                                    __("basic1.manager_tell") }}</label>
                                                <input type="text" value="{{ old("manager_tell") }}"
                                                    class="form-control" id="manager_tell" name="manager_tell" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="manager_adress">{{
                                                    __("basic1.manager_adress") }}</label>
                                                <input type="text" value="{{ old("manager_adress") }}"
                                    ...
                                    <div class="content" id="personal-one-vertical">
                                        ...
                                        <div class="row g-3 mb-4">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_one_girl")}}" class="form-control" id="educational_background_one_girl"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_one_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_one_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_one_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_one_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-two-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_tow_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_tow_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_tow_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_tow_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_tow_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-three-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_three_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_three_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_three_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_three_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_three_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-four-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_four_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_four_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_four_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_four_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_four_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-five-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_five_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_five_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_five_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_five_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_five_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-six-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_six_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_six_boy")
                                            ...
                                            {{--  <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_six_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_six_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_six_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="personal-total-vertical">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_total_girl")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_total_boy")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_total_sum")
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_total_class_count") }}" class="form-control"
                                            ...
                                            <div class="col col-md-6">
                                                ...
                                                <input type="number" value="{{ old("educational_background_total_density") }}" class="form-control"
                                    ...
                                    <div class="content" id="other_info">
                                        ...
                                        <div class="row g-3 mb-4 ">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("total_teachers_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("total_teachers_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("educational_assistant_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("educational_assistant_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("deputy_assistant_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("deputy_assistant_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("breeding_assistant_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("breeding_assistant_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("consultant_working_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("consultant_working_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("sport_coach_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("sport_coach_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("hygiene_coach_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("hygiene_coach_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("breeding_coach_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("breeding_coach_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("servicer_coach_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("servicer_coach_hour") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("janitor_coach_count") }}"
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" value="{{ old("janitor_coach_hour") }}"
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                {{--  <input type="number" value="{{ old("visitors") }}" class="form-control"
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input type="text" value="{{ old("visit_date") }}"
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q1_op1"
                                                                    name="q1_val" type="radio" {{ old("q1_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q1_op2"
                                                                    name="q1_val" type="radio" {{ old("q1_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                    ...
                                                    <div class="col-md">
                                                        ...
                                                        <input type="number" value="{{ old("q1_more",0) }}"
                                                            class="form-control check_val" id="q1_more" name="q1_more" />
                                                    </div>
                                                </div>
                                                <!-- questions 2 -->
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q2_op1"
                                                                    name="q2_val" type="radio" {{ old("q2_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q2_op2"
                                                                    name="q2_val" type="radio" {{ old("q2_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                    ...
                                                    <div class="col-md">
                                                        ...
                                                        <input type="number" value="{{ old("q2_more",0) }}"
                                                            class="form-control check_val" id="q2_more" name="q2_more" />
                                                    </div>
                                                </div>
                                                <!-- questions 3 -->
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q3_op1"
                                                                    name="q3_val" type="radio" {{ old("q3_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q3_op2"
                                                                    name="q3_val" type="radio" {{ old("q3_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                    ...
                                                    <div class="col-md">
                                                        ...
                                                        <input type="number" value="{{ old("q3_more",0) }}"
                                                            class="form-control check_val" id="q3_more" name="q3_more" />
                                                    </div>
                                                </div>
                                                <!-- questions 4 -->
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q4_op1"
                                                                    name="q4_val" type="radio" {{ old("q4_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q4_op2"
                                                                    name="q4_val" type="radio" {{ old("q4_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                    ...
                                                    <div class="col-md">
                                                        ...
                                                        <input type="number" value="{{ old("q4_more",0) }}"
                                                            class="form-control check_val" id="q4_more" name="q4_more" />
                                                    </div>
                                                </div>
                                                <!-- questions 5 -->
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q5_op1"
                                                                    name="q5_val" type="radio" {{ old("q5_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q5_op2"
                                                                    name="q5_val" type="radio" {{ old("q5_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q6_op1"
                                                                    name="q6_val" type="radio" {{ old("q6_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q6_op2"
                                                                    name="q6_val" type="radio" {{ old("q6_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                ...
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q7_op1"
                                                                    name="q7_val" type="radio" {{ old("q7_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q7_op2"
                                                                    name="q7_val" type="radio" {{ old("q7_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                    ...
                                                    <div class="col-md">
                                                        ...
                                                        <input type="number" value="{{ old("q7_more",0) }}"
                                                            class="form-control check_val" id="q7_more" name="q7_more" />
                                                    </div>
                                                </div>
                                                <!-- questions 8 -->
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q8_op1"
                                                                    name="q8_val" type="radio" {{ old("q8_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q8_op2"
                                                                    name="q8_val" type="radio" {{ old("q8_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q9_op1"
                                                                    name="q9_val" type="radio" {{ old("q9_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q9_op2"
                                                                    name="q9_val" type="radio" {{ old("q9_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                ...
                                                <div class="row mb-3">
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic ">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q10_op1"
                                                                    name="q10_val" type="radio" {{ old("q10_val")=="1"
                                                                    ?"checked":"" }} value="1">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-success">بله
                                                                    </span>
                                                        ...
                                                        <div class="form-check custom-option custom-option-basic">
                                                            <label class="form-check-label custom-option-content"
                                                                ...
                                                                <input class="form-check-input" id="q10_op2"
                                                                    name="q10_val" type="radio" {{ old("q10_val")=="0"
                                                                    ?"checked":"" }} value="0">
                                                                <span class="custom-option-header">
                                                                    <span class="h6 mb-0 alert alert-danger">خیر</span>
                                                                </span>
                                                    ...
                                                    {{--  <div class="col-md">
                                                        ...
                                                        <input type="text" value="{{ old("q10_more") }}"
                                    ...
                                    <div class="content" id="tabel_score">
                                        ...
                                        <div class="row mb-5">
                                            ...
                                            {{--  <div class="col-md-4">
                                                ...
                                                <input type="number" value="{{ old($val1['name']."_score")}}" class="form-control" id="{{$val1['name']  }}"
