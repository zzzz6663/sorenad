    ...
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route("look.update",$look->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="row">
                                    ...
                                    <div class="content" id="account-details-vertical">
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" value="{{ old("name",$look->name) }}" class="form-control" id="name" name="name" />
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label" for="personal_code">{{ __("basic2.personal_code")
                                                    }}</label>
                                                <input type="text" value="{{ old("personal_code",$look->personal_code) }}" class="form-control" id="personal_code" name="personal_code" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="years_of_service">{{ __("basic2.years_of_service")
                                                    }}</label>
                                                <input type="number" value="{{ old("years_of_service",$look->years_of_service) }}" class="form-control" id="years_of_service" name="years_of_service" />
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label" for="degree">{{ __("basic2.degree")
                                                    }}</label>
                                                <input type="text" value="{{ old("degree",$look->degree) }}" class="form-control" id="degree" name="degree" />
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="form-label" for="basis_of_teaching">{{ __("basic2.basis_of_teaching")
                                                    }}</label>
                                                <input type="text" value="{{ old("basis_of_teaching",$look->basis_of_teaching) }}" class="form-control" id="basis_of_teaching" name="basis_of_teaching" />
                                            </div>

                                            <div class="col-sm-4">
                                                <label class="form-label" for="student_statistics">{{ __("basic2.student_statistics")
                                                    }}</label>
                                                <input type="text" value="{{ old("student_statistics",$look->student_statistics) }}" class="form-control" id="student_statistics" name="student_statistics" />
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" value="{{ old("school_name",$look->school_name) }}" class="form-control" id="school_name" name="school_name" />
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" value="{{ old("mobile",$look->mobile) }}" class="form-control" id="mobile" name="mobile" />
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="text" value="{{ old("look_date",$look->look_date) }}" class="persian_cal form-control" id="look_date" name="look_date" />
                                            </div>
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <input class="form-check-input" id="pass_priod" type="checkbox"  name="pass_priod" {{ old("pass_priod",$look->pass_priod)=="yes"?"checked":"" }} value="yes">
                                ...
                                <div class="content" id="creative">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 mb-5">
                                            ...
                                            <textarea name="creative" class="form-control" id="" cols="30" rows="5">{{ old("creative",$look->creative) }}</textarea>
                                        </div>
                                        <div class="col-lg-12 mb-5">
                                            ...
                                            <textarea name="problem" class="form-control" id="" cols="30" rows="5">{{ old("problem",$look->problem) }}</textarea>
                                        </div>
                                        ...
                                        <div class="col-sm-12  mb-5">
                                            <label class="form-label" for="visitors">{{ __("field.visitors")
                                                ...
                                                <textarea name="visitors" id="visitors" class="form-control" cols="30" rows="4">{{ old("visitors",$look->visitors) }}</textarea>
                                        </div>
                                        {{--  <div class="col-lg-6  mb-5">
                                            <label class="form-label" for="visitor1_name">{{ __("other2.visitor1_name")
                                                    }}</label>
                                            <input type="text" value="{{ old("visitor1_name",$look->visitor1_name) }}" class="form-control" id="visitor1_name" name="visitor1_name" />
                                        </div>
                                        <div class="col-lg-6  mb-5">
                                            <label class="form-label" for="visitor1_val">{{ __("other2.visitor1_val")
                                                  }}</label>
                                            <input type="text" value="{{ old("visitor1_val",$look->visitor1_val) }}" class="form-control" id="visitor1_val" name="visitor1_val" />
                                        </div>

                                        <div class="col-lg-6  mb-5">
                                            <label class="form-label" for="visitor2_name">{{ __("other2.visitor2_name")
                                                    }}</label>
                                            <input type="text" value="{{ old("visitor2_name",$look->visitor2_name) }}" class="form-control" id="visitor2_name" name="visitor2_name" />
                                        </div>
                                        <div class="col-lg-6  mb-5">
                                            <label class="form-label" for="visitor2_val">{{ __("other2.visitor2_val")
                                                  }}</label>
                                            <input type="text" value="{{ old("visitor2_val",$look->visitor2_val) }}" class="form-control" id="visitor2_val" name="visitor2_val" />
                                        </div>  --}}
  ...
  --}}
        ...
        {{-- <div class="mb-3">
                        ...
                        <select class="form-select" id="active" name="active">
                            <option value="">انتخاب کنید </option>
                            <option {{ old("active")==,$look->active"1" ?"selected":"" }} value="1">فعال</option>
        <option {{ old("active")==,$look->active"0" ?"selected":"" }} value="0">غیر فعال</option>
        </select>
    </div> --}}
    <div class="mb-3">
