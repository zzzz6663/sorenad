    ...
    <div class="col-md-12">
        <div class="card mb-4">
            <h5 class="card-header">
                ...
                ویرایش سند
           <span class="alert alert-success"> {{ $doc->id }}</span>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3 red">
                                ...
                                <input name="debt_price" class="form-control number_format" id="debt_price"
                                    placeholder="  " type="number" value="{{ old("debt_price",$doc->debt_price) }}">
                                @if(old("debt_price"))
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2" id="debt_id" name="debt_id">
                                    ...
                                    <option {{ old("debt_id",$doc->debt_id)==$accont->id?"selected":"" }} value="{{ $accont->id }}">{{
                                        $accont->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="mb-3 ">
                                ...
                                <select class="form-select select2" id="demand_id" name="demand_id">
                                    ...
                                    <option {{ old("demand_id",$doc->demand_id)==$accont_d->id?"selected":"" }} value="{{ $accont_d->id
                            ...
                            {{--  <div class="mb-3 green">
                                ...
                                <input name="demand_price" class="form-control number_format" id="demand_price"
                                    placeholder="  " type="number" value="{{ old("demand_price",$doc->demand_price) }}">
                                @if(old("demand_price"))
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input name="submited" class="form-control persian_cal" id="submited" placeholder="  "
                                    type="text" value="{{ old("submited",$doc->submited) }}">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="info" id="" class="form-control" cols="10"
                                    rows="5">{{ old("info",$doc->info) }}</textarea>
                            </div>
