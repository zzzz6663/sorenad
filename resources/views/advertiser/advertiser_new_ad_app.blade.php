...
@section('content')
<h2 class="title_right">سفارش تبلیغ پاپ آپ</h2>
...
<form action="{{ route("advertiser.new.ad.app") }}" method="post" enctype="multipart/form-data">
    ...
    <div class="alert_box">
        ...
        <p>این نوع تبلیغ فقط در موبایل نمایش داده میشود و برای افزایش نصب اپلیکیشن اندروید مناسب است.</p>
    </div>
    ...
    <div class="dashboard_site_form">
            ...
            <p class="span_block">
                <label for="login_link_page">لینک دانلود برنامه</label>
                <input type="url" id="login_link_page" name="login_link_page" value="{{ old("login_link_page") }}">
            ...
            <p>
                <label for="download_name">متن دکمه دانلود</label>
                <input type="text" id="download_name" name="download_name" value="{{ old("download_name") }}">
            ...
            <div class="flex_tworow appads_upload_icon">
                ...
                <p>
                    <label for="banner">آپلود بنر برنامه</label>
