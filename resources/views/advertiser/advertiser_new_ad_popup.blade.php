...
<form action="{{ route("advertiser.new.ad.popup") }}" method="post">
    ...
    <div class="alert_box">
        ...
        <p>این نوع تبلیغ تنها در پشت پنجره کاربر نمایش داده میشود و وارد کردن لینک کانال روبیکا، تلگرام و پیج اینستاگرام ممنوع است.</p>
    </div>

    <div class="alert_box green_alert_box">
        <i class="fa fa-info-circle"></i>
        <p>این تبلیغ برای افزایش بازدید سایت مناسب است.</p>
    </div>
    ...
    <div class="dashboard_site_form">
        ...
        <div class="card_pay_box">
            ...
            @if( old("view_count"))
            <p>مجموع هزینه <span class="after_tax_price">{{(number_format( (old("view_count")*$price)+ (( old("view_count")*$price*4.5)/100)))." تومان" }}</span> </p>
            @endif
            </span> </p>
            <p>
